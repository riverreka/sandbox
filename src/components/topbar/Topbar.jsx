      ...
      <div className='wrapper'>
        <div className="left">
          <a href="#intro" className='iconHouse'>
            <svg className="MuiSvgIcon-root iconHouse" focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3 4.2 15.5l1.7 1.06L7 14.8V21h4v-5h2v5h4v-6.21l1.1 1.77 1.7-1.06L12 3zm1 11h-2v-2h2v2z"></path></svg>
          </a>
